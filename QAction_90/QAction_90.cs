...
public static class QAction
{
    ...
    public static void Run(SLProtocolExt protocol)
    {
        try
        {
            ...
            /*
            TO BE DONE. setting a column is too much of a burden
            ...
            {
                ///valueCol[i] = (object)((((int)(valueCol[i])) + 1) % 4);
                strKeyCol[i] = (string)keyCol[i];
            }

            protocol.tbleventsoverview.SetColumn(2, strKeyCol, valueCol, false);
            */
